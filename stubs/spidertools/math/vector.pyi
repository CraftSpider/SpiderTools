...
from typing import Union, List, Dict, Any, TypeVar, Tuple, Sequence
import numbers

_T = TypeVar("_T")
_U = TypeVar("_U")
ValidVector = Union['Vector', numbers.Real]
_Matrix = Tuple[Tuple[numbers.Real, ...], ...]

def _getdef(list: List[_T], num: int, default: _U) -> Union[_T, _U]: ...

def _narrow(list: List[_T], l: int) -> List[_T]: ...

def _cut_matrix(matrix: _Matrix, pos: int) -> _Matrix: ...

def _determinant(matrix: _Matrix) -> float: ...

def _semi_determinant(matrix: _Matrix) -> Tuple[numbers.Real, ...]: ...

def _vecs_to_tuple(vecs: Sequence['Vector'], dims: int = ...) -> _Matrix: ...
...
class Vector:
    ...
    def __getitem__(self, item: int) -> numbers.Real: ...

    def __setitem__(self, key: int, value: numbers.Real) -> None: ...
    ...
    @classmethod
    def get_orthogonal(cls, *vecs: 'Vector') -> 'Vector': ...
    ...
    def to_tuple(self, d: int = ...) -> Tuple[numbers.Real, ...]: ...
